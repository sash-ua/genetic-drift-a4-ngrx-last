## The simple web application [Modeling Genetic drift v.1.0.0-beta.0 (Angular 4 + Redux (NGRX)), demo]( https://sash-ua.github.io/genetic-drift-a4-ngrx-last/ ). [Code]( https://github.com/sash-ua/genetic-drift-a4-ngrx-last ).
